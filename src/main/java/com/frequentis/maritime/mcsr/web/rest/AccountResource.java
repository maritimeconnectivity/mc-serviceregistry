...
import com.frequentis.maritime.mcsr.web.rest.dto.KeyAndPasswordDTO;
...
public class AccountResource {
    ...
    public ResponseEntity<String> saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        return userRepository
            .findFirstByLogin(SecurityUtils.getCurrentUserLogin())
            .map(u -> {
    ...
    public ResponseEntity<List<PersistentToken>> getCurrentSessions() {
        return userRepository.findFirstByLogin(SecurityUtils.getCurrentUserLogin())
