...
public class ServiceSpecificationResource {
	 ...
	 *
	 * @param specification
	 *            the specification to create
	 * @return the ResponseEntity with status 201 (Created) and with body the
	 *         new specification, or with status 400 (Bad Request) if the
	 *         specification has already an ID
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@RequestMapping(value = "/serviceSpecification", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	public ResponseEntity<Specification> createSpecification(@Valid @RequestBody Specification specification,
	        @RequestHeader("Authorization") String bearerToken) throws Exception, URISyntaxException {
		...
		if (specification.getId() != null) {
			return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert("specification", "idexists",
			        "A new specification cannot already have an ID")).body(null);
		}
	 ...
	 *
	 * @param specification
	 *            the specification to update
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         specification, or with status 400 (Bad Request) if the
	 *         specification is not valid, or with status 500 (Internal Server
	 *         Error) if the specification couldnt be updated
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@RequestMapping(value = "/serviceSpecification", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	public ResponseEntity<Specification> updateSpecification(@Valid @RequestBody Specification specification,
	        @RequestHeader("Authorization") String bearerToken) throws Exception, URISyntaxException {
	 ...
	 */
	@RequestMapping(value = "/serviceSpecification", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	public ResponseEntity<List<Specification>> getAllSpecifications(Pageable pageable) throws URISyntaxException {
	...
	/**
	 * GET /serviceSpecification/:id/:version : get the "id" specification of
	 * version "version".
	 *
	 * @param id
	 *            the id of the specification to retrieve
	 * @param version
	 *            the version of the specification to retrieve, "latest" for the
	 *            highest version number
	 * @return the ResponseEntity with status 200 (OK) and with body the
	 *         specification, or with status 404 (Not Found)
	 */
	@RequestMapping(value = "/serviceSpecification/{id}/{version}/", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	...
	public ResponseEntity<Specification> getSpecification(@PathVariable String id, @PathVariable String version) {
		...
		return Optional.ofNullable(specification).map(result -> new ResponseEntity<>(result, HttpStatus.OK))
		        .orElse(new ResponseEntity<>(HttpStatus.NOT_FOUND));
	}

	/**
	 * GET /serviceSpecification/:id : get all specifications with id "id"
	 * across all versions.
	 *
	 * @param id
	 *            the domain id of the specification to retrieve
	 * @return the result of the search
	 */
	@RequestMapping(value = "/serviceSpecification/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	public ResponseEntity<List<Specification>> getAllSpecificationsById(@PathVariable String id, Pageable pageable)
		...
		HttpHeaders headers = PaginationUtil.generateSearchPaginationNoQueryHttpHeaders(page,
		        "/api/serviceSpecification/" + id);
		return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
	}

	/**
	 * DELETE /serviceSpecification/:id/:version : delete the "id" specification
	 * of version "version".
	 *
	 * @param id
	 *            the id of the specification to delete
	 * @param version
	 *            the version of the specification to delete
	 * @return the ResponseEntity with status 200 (OK)
	 */
	@RequestMapping(value = "/serviceSpecification/{id}/{version}/", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	public ResponseEntity<Void> deleteSpecification(@PathVariable String id, @PathVariable String version,
	...
	/**
	 * SEARCH /_search/serviceSpecification?query=:query : search for the
	 * specification corresponding to the query.
	 *
	 * @param query
	 *            the query of the specification search
	 * @return the result of the search
	 */
	@RequestMapping(value = "/_search/serviceSpecification", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	...
	/**
	 * STATUS UPDATE /serviceSpecification/:id/:version/status: update status of
	 * the "id" service specification of version "version"
	 *
	 * @param id
	 *            the id of the specification to deprecate
	 * @param version
	 *            the version of the specification to deprecate
	 * @param status
	 *            the new status
	 * @return the result of the operation
	 */
	@RequestMapping(value = "/serviceSpecification/{id}/{version}/status", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_VALUE)
	@Timed
	public ResponseEntity<Void> updateSpecificationStatus(@PathVariable String id, @PathVariable String version,
	        @RequestParam String status, @RequestHeader("Authorization") String bearerToken)
