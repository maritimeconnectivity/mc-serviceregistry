...
public interface InstanceRepository extends JpaRepository<Instance,Long> {
    ...
    @Query("select distinct instance from Instance instance left join fetch instance.designs left join fetch instance.docs where instance.instanceId = :id and instance.compliant = true")
    ...
    @Query("select distinct instance from Instance instance left join fetch instance.designs left join fetch instance.docs where instance.instanceId = :id and instance.version = :version and instance.compliant = true")
